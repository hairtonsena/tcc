        ...
        <div id="tela" >
            <div class="semMarge thumbnail" style="height: 7%">
                <div class="span10 tamanhoColunaEsquedo semMarge" style="margin: 3px 0px 0px 0px">
                    <!--<form class="form-inline" onsubmit="Problema.pesquisaLocal(); return false" >-->
                    ...
                    <div class="span5" style="margin: 6px 0px 0px 20px" >
                        <div class="input-append"> 
                            ...
                            <button type="submit" class="btn"><i class="icon-search"></i> Pesquisa  </button>
                        </div>
                    </div>
                    <!--</form>-->
                ...
                <div class="span2 tamanhoColunaDireita semMarge"  >
                    <div class="" style="margin: 0px 0px 0px 1px;">
                        <img src="<?php echo base_url(); ?>icone/moc.png" style="height: 100%"  /> Montes Claros    
                    </div>
                </div>
            </div>
            ...
            <div class="span3 tamanhoColunaDireita" id="calunaDireita" style="background-color: #eeeeee">
                <div id="filtros" >
                    ...
                    <button type="submit" class="btn pull-right" onclick="Problema.verColaboracoes('a');" > <i class="icon-filter"></i> Filtrar </button>
                </div>
