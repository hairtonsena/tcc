...
<div class="modal-body">
    ...
    <form action="#" onsubmit="return Problema.rejeitarColaboracao()" method="post">
        ...
        <div class="form-group">
            ...
            <textarea rows="4" name="textoUsuario" id="textoUsuario" class="form-control" >[usuário], infelizmente o problema urbano que você reportou foi rejeitado por não respeitar os termos de uso.
Pedimos que leia os temos de usuário antes de reportar um novo problema. Agradecemos a sua compreensão.</textarea>
        </div>
