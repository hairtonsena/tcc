...
<div class="thumbnail " style="background-color: #eee;" id="pnlLogin">
    ...
    <form action="#" onsubmit="return Problema.tornaPendenteColaboracao()" method="post">
        <fieldset>
            <legend> Tornar Pendente Colaboração </legend>
            <label>Mensagens Para o usuario</label>
            <textarea rows="4" name="textoUsuario" id="textoUsuario" class="span3" >Sua colaboração precisa ser complementada para facilitar a compreenção do jestor. Por favor acesse o sistema novamente e complemente sua manifestação</textarea>
