...
<div class="modal-body">
    <form action="#" onsubmit="return Problema.aceitaColaboracao()" method="post">
        ...
        <div class="form-group">
            ...
            <textarea rows="4" name="textoUsuario" id="textoUsuario" class="form-control" > [usuário], o problema que você nos apresentou foi aceito. Nossa administração estará trabalhando para suas melhorias e satisfações.</textarea>
        </div>
